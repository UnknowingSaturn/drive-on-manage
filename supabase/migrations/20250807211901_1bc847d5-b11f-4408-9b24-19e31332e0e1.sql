-- Create a test function to verify company creation works with proper authentication
...
BEGIN
  ...
  VALUES (company_name, company_email, company_phone, company_address, sub_tier, true)
