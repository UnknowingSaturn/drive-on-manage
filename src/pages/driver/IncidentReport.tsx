    ...
    input.onchange = async (e) => {
      ...
      try {
        ...
        const uploadPromises = files.map(async (file) => {
          ...
          const fileName = `${user?.id}/incident_${Date.now()}_${Math.random()}.${fileExt}`;
        ...
        toast({
          ...
          description: `${uploadedPaths.length} photo(s) uploaded and will be attached to your incident report.`,
        });
