  ...
  return (
    <div className="saas-main">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Today's Route Info */}
        <Card className="saas-card md:col-span-2">
          ...
          <CardContent className="saas-card-content">
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-primary">{todaySOD?.parcel_count || 0}</div>
                <div className="text-sm text-muted-foreground">Assigned Parcels</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-success">{totalDeliveries}</div>
                <div className="text-sm text-muted-foreground">Completed</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-muted-foreground">{(todaySOD?.parcel_count || 0) - totalDeliveries}</div>
          ...
          <CardContent className="saas-card-content">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-lg text-primary">£{weeklyEarnings.toFixed(2)}</span>
              </div>
              <div className="pt-2">
                <Button 
            ...
            <CardContent className="saas-card-content">
              <div className="space-y-3">
                <div className="text-center">
                  ...
                  <div className="text-sm text-muted-foreground">{assignedVan.make} {assignedVan.model}</div>
                </div>
                <Button 
